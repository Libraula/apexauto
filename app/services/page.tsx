...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            {services.map((service, index) => (
              <Card
                key={index}
                className={`bg-slate-800/30 border-slate-700 overflow-hidden ${service.popular ? "ring-2 ring-blue-500" : ""}`}
              >
                <div className="grid lg:grid-cols-2 gap-8">
                  <div className="relative">
                    ...
                    />
                    {service.popular && (
                      <Badge className="absolute top-4 left-4 bg-blue-600 text-white">Most Popular</Badge>
                    )}
                  </div>
                  <div className="p-8">
                    ...
                    {service.addOns.length > 0 && (
                      <div className="mb-6">
                        <h4 className="text-white font-semibold mb-3">Popular Add-ons:</h4>
      ...
      <section className="py-16 lg:py-20 bg-slate-900/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Add-on Services</h2>
            <p className="text-xl text-slate-300">Enhance your detailing package with these specialized services</p>
          </div>
            ...
            {addOnServices.map((addOn, index) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-400">{addOn.description}</CardDescription>
                </CardHeader>
              </Card>
            ))}
          </div>
          ...
          <Card className="bg-slate-800/30 border-slate-700">
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-4">Vehicle Size Adjustments</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-4">Condition Surcharges</h3>
                  <ul className="space-y-2 text-slate-300">
                    <li className="flex justify-between">
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-20 bg-gradient-to-r from-blue-900/20 to-slate-900/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Ready to Transform Your Car?</h2>
