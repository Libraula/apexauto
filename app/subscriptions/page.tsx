...
export default function SubscriptionsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* Hero Section */}
      <section className="py-16 bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <Badge className="bg-blue-600/20 text-blue-400 border-blue-600/30 mb-4">
              Save up to 30% with Monthly Plans
            </Badge>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Keep Your Car Clean All Year</h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`relative bg-slate-800/30 border-slate-700 hover:bg-slate-800/50 transition-all duration-300 ${plan.popular ? "ring-2 ring-blue-500 scale-105" : ""}`}
              >
                {plan.popular && (
                ...
                <CardHeader className="text-center pb-8">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-2">
                      <span className="text-slate-500 line-through text-sm">{plan.originalPrice}/month one-off</span>
                    </div>
                    <Badge variant="outline" className="border-green-600 text-green-400 mt-2">
                      {plan.savings}
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent className="pt-0">
                  ...
                  <Link href="/subscribe" className="block">
                    <Button
                      className={`w-full ${plan.popular ? "bg-blue-600 hover:bg-blue-700" : "bg-slate-700 hover:bg-slate-600"} text-white font-semibold`}
                    >
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Why Subscribe to Apex?</h2>
            <p className="text-xl text-slate-300">More than just savings - enjoy exclusive subscriber benefits</p>
          </div>
      ...
      <section className="py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">How Monthly Plans Work</h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900/20 to-slate-900/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Ready to Save with Monthly Plans?</h2>
