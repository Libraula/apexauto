...
import { CheckCircle, Star, Clock, Shield, Gift } from "lucide-react"
  ...
  const plans = [
    {
      ...
      popular: false,
      color: "from-apex-teal-blue to-apex-dark-blue",
      buttonClass: "bg-apex-teal-blue hover:bg-apex-teal-blue/90",
    },
    {
      name: "Stay Fresh",
      price: "$159",
      ...
      popular: true,
      color: "from-apex-red to-apex-orange",
      buttonClass: "bg-apex-red hover:bg-apex-red/90",
    },
    {
      ...
      popular: false,
      color: "from-apex-gold to-apex-orange",
      buttonClass: "bg-apex-gold hover:bg-apex-gold/90 text-apex-dark-blue",
    },
  ]
    ...
    <div className="min-h-screen bg-apex-dark-blue">
      ...
      <section className="py-16 bg-gradient-to-br from-apex-dark-blue via-apex-dark-blue to-apex-teal-blue">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <Badge className="bg-apex-gold text-apex-dark-blue border-apex-gold/30 mb-4 font-semibold px-3 py-1 text-sm">
            Save up to 30% with Monthly Plans
          </Badge>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-apex-light-grey mb-6">
            Keep Your Car <span className="text-apex-gold">Clean All Year</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`relative bg-apex-teal-blue/20 border-apex-teal-blue hover:bg-apex-teal-blue/30 transition-all duration-300 ${
                  plan.popular ? "ring-2 ring-apex-red scale-105" : ""
                }`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-apex-red text-apex-light-grey px-4 py-1 font-semibold">Most Popular</Badge>
                  </div>
                )}

                <CardHeader className="text-center pb-8">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${plan.color} flex items-center justify-center shadow-lg`}
                  >
                    <Star className="w-8 h-8 text-apex-light-grey" />
                  </div>
                  <CardTitle className="text-2xl font-bold text-apex-light-grey">{plan.name}</CardTitle>
                  <CardDescription className="text-apex-light-grey/70 mt-2">{plan.description}</CardDescription>

                  <div className="mt-6">
                    <div className="flex items-center justify-center space-x-2">
                      <span className="text-4xl font-bold text-apex-gold">{plan.price}</span>
                      <span className="text-apex-light-grey/70">/month</span>
                    </div>
                    <div className="mt-2">
                      <span className="text-apex-light-grey/50 line-through text-sm">
                        {plan.originalPrice}/month one-off
                      </span>
                    </div>
                    <Badge variant="outline" className="border-apex-gold text-apex-gold mt-2 font-semibold">
                      {plan.savings}
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent className="pt-0">
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start text-apex-light-grey/80">
                  ...
                  <Link href="/subscribe" className="block">
                    <Button
                      className={`w-full ${plan.buttonClass} text-apex-light-grey font-semibold py-6 shadow-lg shadow-apex-teal-blue/20`}
                    >
      ...
      {/* Benefits Section */}
      <section className="py-20 bg-gradient-to-r from-apex-dark-blue to-apex-teal-blue/40">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-apex-light-grey mb-4">Why Subscribe to Apex?</h2>
            <p className="text-xl text-apex-gold">More than just savings - enjoy exclusive subscriber benefits</p>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="pt-8 pb-6">
                  <benefit.icon className="w-12 h-12 text-apex-gold mx-auto mb-4" />
                  <h3 className="text-xl font-semibold text-apex-light-grey mb-2">{benefit.title}</h3>
                  <p className="text-apex-light-grey/70 text-sm">{benefit.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-apex-light-grey mb-4">How Monthly Plans Work</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-apex-red to-apex-orange text-apex-light-grey rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg shadow-apex-red/20">
                  {step.step}
                </div>
                <h3 className="text-xl font-semibold text-apex-light-grey mb-2">{step.title}</h3>
                <p className="text-apex-light-grey/70">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* FAQ Section */}
      <section className="py-20 bg-apex-teal-blue/10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-apex-light-grey mb-4">Frequently Asked Questions</h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-apex-teal-blue/20 to-apex-dark-orange/20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-apex-light-grey mb-6">
            Ready to Save with Monthly Plans?
          </h2>
          <p className="text-xl text-apex-gold mb-8 max-w-2xl mx-auto">
